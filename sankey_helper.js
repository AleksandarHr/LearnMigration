...
// load the data
d3.csv("filteredsankey.csv", function(error, data) {
...
function showDetail(event, key, amount) {
    ...
    y_hover = (document.body.clientHeight - event.pageY < (tooltipHeight + 4)) ? event.pageY - (tooltipHeight - 100) : event.pageY - tooltipHeight - 40;
