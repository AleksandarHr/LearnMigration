...
//            self.id_readys(map, country_names, countries_and_centroids, flows, pop,
//                inflow_bool, selected_year0, min_flow_threshold, selected_gender,
//                normalized_bool, path, radius_scale);
...
//    id_readys(map, countries, countries_and_centroids, flows, pop,
//                  inflow_bool, selected_year0, min_flow_threshold, selected_gender,
//                  normalized_bool, path, radius_scale) {
//        id_ready(map, countries, countries_and_centroids, flows, pop,
//            inflow_bool, selected_year0, min_flow_threshold, selected_gender,
//            normalized_bool, path, radius_scale);
//    }
